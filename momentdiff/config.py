...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--dset_name", type=str, choices=["hl", 'tvsum','charades','charades_vgg','charades_c3d','activity','activity_sf','activity_shuffle','tacos'])
        ...
        parser.add_argument("--lr_drop", type=int, default=40, help="drop learning rate to 1/10 every lr_drop epochs")
        parser.add_argument("--wd", type=float, default=1e-4, help="weight decay")
        parser.add_argument("--n_epoch", type=int, default=100, help="number of epochs to run")
        parser.add_argument("--max_es_cnt", type=int, default=80,
    ...
    def parse(self, a_feat_dir=None):
        ...
        if isinstance(self, TestOptions):
            ...
            save_fns = ['momentdiff/model.py', 'momentdiff/transformer.py']
