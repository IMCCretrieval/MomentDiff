...
def eval_moment_retrieval(submission, ground_truth, verbose=True, dset_name='hl'):
    # import pdb; pdb.set_trace()
    if dset_name == 'charades' or dset_name == 'charades_vgg' or dset_name == 'charades_c3d':
        length_ranges = [[0, 15], [15, 30], [0, 150], ]  #
        range_names = ["short", "middle", "full"]
    elif dset_name == 'activity' or dset_name == 'activity_sf' or dset_name == 'activity_shuffle':
...
def eval_submission(submission, ground_truth, verbose=True, match_number=True, dset_name='hl'):
    """
    Args:
    ...
    if "pred_relevant_windows" in submission[0]:
        moment_ret_scores = eval_moment_retrieval(
            submission, ground_truth, verbose=verbose, dset_name=dset_name)
        ...
        moment_ret_scores_brief = {
            ...
            "MR-long-mAP": moment_ret_scores["long"]["MR-mAP"]["average"] if dset_name != 'charades' and dset_name != 'charades_vgg'and dset_name != 'charades_c3d' else None,
        }
